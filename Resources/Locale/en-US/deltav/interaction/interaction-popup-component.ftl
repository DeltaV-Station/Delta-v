...
petting-success-nukie-mothroach = You pet {THE($target)} on {POSS-ADJ($target)} little fluffy blood-red syndicate mothroach head.
petting-failure-nukie-mothroach = You reach out to pet {THE($target)}, but {SUBJECT($target)} dodges you and looks at you disgruntled.
