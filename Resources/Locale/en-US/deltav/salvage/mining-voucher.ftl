...
mining-voucher-crusher-description =
    ...
    The crusher is a versatile melee mining tool capable both of mining and fighting local fauna, however it is difficult to use effectively for anyone but most skilled and/or suicidal miners.

mining-voucher-extraction-name = Extraction and Rescue Kit
mining-voucher-extraction-description =
    Contains a fulton beacon and 20 fultons, which allows you to send minerals, items and dead bodies back home without having to use the mining shuttle.
...
mining-voucher-resonator-description =
    ...
    The resonator is a handheld device that creates small fields of energy that resonate until they detonate, crushing rock.
...
mining-voucher-conscription-description =
    Contains a whole new mining starter kit for one crewmember, including a proto-kinetic accelerator, mineral scanner, ID card and other useful gear.
