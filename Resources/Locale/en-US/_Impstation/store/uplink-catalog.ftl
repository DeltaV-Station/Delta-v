...
uplink-basilisk-name = basilisk
uplink-basilisk-desc = An experimental weapon that fires bolts of pure radiation, perfect for frying a target's insides. Comes with 2 canisters of its proprietary liquid ammo.
...
uplink-echion-synth-desc = An advanced catalyser that produces Echion at a steady rate while powered. Compatible with the Adder, Akurra, and Basilisk.
