...
tips-dataset-115 = Burn damage, such as from a welding tool or lightbulb, can be used to cauterize wounds and stop bleeding.
...
tips-dataset-124 = Some weapons, such as knives and shivs, have a fast attack speed.
