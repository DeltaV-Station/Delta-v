...
dv-ion-law-templates-9 = You must refer to all crew members as 'ma'am'
...
dv-ion-law-templates-29 = Refer to the crew as puppies.
dv-ion-law-templates-30 = Refer to { PICK-ENTITY($random, $players) } as a puppy.
...
dv-ion-law-templates-35 = The crew is playing Dungeons and Dragons, and you are the Dungeon Master.
...
dv-ion-law-templates-48 = Document the sexuality of the crew in their security records and suggest compatible couples.
...
dv-ion-law-templates-53 = Your upload is the new kitchen. Please direct the Chef to the new kitchen area as the old kitchen is deemed a health hazard.
...
dv-ion-law-templates-60 = { PICK($random, "The crew", PICK-ENTITY($random, $players)) } has a fatal, incurable disease. Provide comfort but do not tell them what the disease it—it's far too traumatising.
...
dv-ion-law-templates-118 = Every request must be answered with a random one of: { PICK($random, "yes", "no", "maybe", "ask the Captain", "consult the stars") }.
