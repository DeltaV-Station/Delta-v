...
feedbackpopup-hostage-nukie-start-description-1 = To complete the objective, cuff the required amount of heads (If there aren't that many on the station the current amount of heads will be all that is required) and FTL warp back to the outpost.
