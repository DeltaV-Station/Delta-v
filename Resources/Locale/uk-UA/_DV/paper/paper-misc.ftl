book-text-lunchbox-generic = Привіт, мила!
      I've packed your lunch for this shift, I hope you enjoy it!!
      Love you so so much,
       - Mum.
book-text-lunchbox-healthy = Привіт, мила!
      I've packed you something healthy for this shift! I hope you enjoy it!!
      Love you so so much,
       - Mum.
book-text-lunchbox-unhealthy = Привіт, мила!
      I've packed you something fun for this shift! I hope you enjoy it!!
      Love you so so much,
       - Mum.
book-text-gorlex-girlfriends-subscription-notice = [head=2]Вітаємо, постійний підписник,[/head]
...
book-text-centcomm-chads-subscription-notice = [head=2]Вітаємо, постійний підписник,[/head]
...
paper-salvage-gun-safe-notice = ПОВІДОМЛЕННЯ ПРО ОЗБРОЄННЯ САМООБОРОНИ ФАХІВЦЮ З РЯТУВАННЯ
...
paper-viral-care-package-manual = [color=#134975]░░██░░ [head=2]Посібник із пакету засобів лікування вірусів[/head]
