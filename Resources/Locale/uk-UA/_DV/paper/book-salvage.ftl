...
book-text-vulpkanin = Vulpkanin for Dummies, вичерпний посібник
...
book-text-gorlexgirlfriend = Це 197-ма версія сумно відомого журналу Gorlex Girlfriends. Цей випуск містить кілька фотографій та інтерв’ю кількох агентів, які працюють у синдикаті разом із акторами, які працюють над телешоу Syndicate «Nukies». Найкраща частина, безумовно, була про Оперативний листопад, яка є зіркою цього видання, з її фотографією на обкладинці.
...
book-text-centcomm-chad = 56-е видання нещодавно випущеної серії CentComm Chads. Це видання містить декілька фотографій посадових осіб CentComm і командування станції «на грі», незалежно від того, чи то в спортзалі, чи в офісі під час роботи. Найкраща колекція — від обкладинки моделі Commander Chad, яка насолоджується відпочинком на пляжі, слухаючи подкаст CC.
...
book-text-ancientbookcommon-1 = {CAPITALIZE(THE($user))} підписує {THE($target)}.
...
book-text-ancientbookrare-1 = [head=3]СЕКТОР ДЕЛЬТА, РЕГІОН ЛОКАЛЬНОГО ПРОСТОРУ[head=3]
...
book-text-ancientbookrare-2 = Я дивився незворушними, наляканими очима на величезні простори зруйнованого міста переді мною. Імена дантистів, юристів і лікарів, які, напевно, вже були мертві, лежали розбиті та розкидані на повалених вивісках і рекламних щитах. Частинки пилу та листя безцільно танцювали навколо, зливаючись у мініатюрні торнадо, перш ніж безцеремонно впасти на себе. Я стиснув забинтоване зап’ястя й пішов вперед крізь розбите скло й шматки асфальту.
...
book-text-ancientbookrare-3 = Станційні істоти надто нудні для вас? Хочете знайти нового екзотичного друга, щоб похвалитися командою? Це посібник для вас!
