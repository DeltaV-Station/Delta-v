...
book-text-demonomicon3 = Класні імена демонів, які я знайшов
      - by Ms. Mossrock
...
book-text-chemistry-insane = лист
...
book-text-botanics = ** Застосування ботанічних зразків, знайдених на територіях Nanotrasen **
...
book-text-gnome = Слава нашому Королю гномів
...
book-text-fishing = Коли я виросту, я хочу бути одним із жниварів космічного моря!
...
book-text-detective = РОЗДІЛ 1: МАЛЕНЬКІ ПРИГОДИ НА ВЕЛИКОМУ ВОКЗАЛІ
