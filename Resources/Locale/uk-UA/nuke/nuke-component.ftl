...
nuke-component-cant-anchor-toggle = Диск ядерної автентифікації потрібен для перемикання болтів підлоги!
...
nuke-disk-component-microwave = Диск трохи іскрить і шипить, але здається майже неушкодженим?
