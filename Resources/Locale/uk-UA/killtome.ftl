...
killtome-kill-success = Ім'я написано. Починається зворотній відлік.
killtome-death = Ви відчуваєте раптовий біль у грудях!
killtome-death-others = {CAPITALIZE($target)} хапається за груди {POSS-ADJ($target)} і падає на землю!