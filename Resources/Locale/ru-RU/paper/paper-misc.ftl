...
book-text-subscription-notice = [head=2]Здраствуй дорогой подписчик,[/head]

      Мы надеемся, что Вам понравится этот ежемесячник "Девочки Горлакса™, спонсированный Синдикатом.

      В этом выпуске месяца мы отправимся за кулисы с некоторыми из наших знаменитых актеров, работающих над потрясающим телешоу "[color=#780606]Nukies[/color]", и, возможно, покажем несколько тизеров для следующего сезона. Читайте личное интервью с любимой оперативницей Новембер, в котором она рассказывает о проблемах с попаданием поддельной крови на ее волосы!

      Все это и многое другое ждет вас внутри!
