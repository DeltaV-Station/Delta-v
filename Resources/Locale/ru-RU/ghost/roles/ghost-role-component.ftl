...
ghost-role-information-closet-skeleton-description = ghost-role-information-closet-skeleton-description = Вы сотрудник станции, который по непонятным причинам пребывал в шкафу так долго, что превратился в скелета...(МИРНЫЙ по отношению к станции)
