...
reagent-name-ElectrificatedWater = Наэлектризованная вода
reagent-desc-ElectrificatedWater = Бесконечный источник электричества, о котором все забыл
reagent-name-shittypotion = Говно-зелье
reagent-desc-shittypotion = Это зелье с крайне резким запахом. Оно выглядит слишком отвратительно чтобы его пить
reagent-name-nonshittypotion = Не Говно-зелье
reagent-desc-nonshittypotion = Это зелье с немного резким запахом. На вид как яблочный сок, но это точно не он
reagent-name-antifallpotion = Зелье против сноса
reagent-desc-antifallpotion = Зелье в названии которого точно нет подвохов, оно будет защищать вас от любого падения
reagent-name-adiarine3 = Адиарин 3
reagent-desc-adiarine3 = Адиарин 3, к сожалению из-за древности этого лекарства оно не работает
reagent-name-redpotion = Красное зелье
reagent-desc-redpotion = Это зелье с ярко-красным оттенком. На вкус похожа на воду с красителем
reagent-name-badwater = Зацветшая вода
reagent-desc-badwater = 100% не 125 летняя вода из бочки
reagent-name-grepotion = Серое зелье
reagent-desc-grepotion = Это зелье серого цвета... всё...
reagent-name-gray-brown-raspberry = Cеробурмалиновое зелье
reagent-desc-gray-brown-raspberry = Это зелье с очень странным оттенком. Говорят что такого цвета не существует, но ведь я прямо сейчас на него смотрю. Вокруг одни лжецы...
reagent-name-soh = Сох
reagent-desc-soh = Это сок, но для людей у которых проблемы с произношением
