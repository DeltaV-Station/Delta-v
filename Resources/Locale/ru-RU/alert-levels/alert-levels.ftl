...
alert-level-beta-announcement = На станции присутствует враждебная флора или фауна. Службе безопасности разрешено иметь при себе оружие. Членам экипажа следует избегать прямого контакта с угрозой и содействовать с службой безопасности для ее устранения. Несанкционированные обыски запрещены.
alert-level-beta-instructions = Остерегайтесь прямого контакта с угрозой и содействуйте службе безопасности.
