...
public sealed class HealthAnalyzerScannedUserMessage : BoundUserInterfaceMessage
{
    ...
    public HealthAnalyzerScannedUserMessage(NetEntity? targetEntity, float temperature, float bloodLevel, bool? scanMode, bool? bleeding, bool? unrevivable, Dictionary<TargetBodyPart, TargetIntegrity>? body, MedicalRecord? medicalRecord, NetEntity? part = null) // Shitmed Change // DeltaV - Medical Records
    {
