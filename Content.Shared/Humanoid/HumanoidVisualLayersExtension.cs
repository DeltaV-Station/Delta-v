        ...
        public static IEnumerable<HumanoidVisualLayers> Sublayers(HumanoidVisualLayers layer)
        {
            switch (layer)
            {
                ...
                case HumanoidVisualLayers.LArm:
                    ...
                    yield return HumanoidVisualLayers.LArmExtension; // Delta V Nubody - Add Frontier LArmExtension for Harpies
                    yield return HumanoidVisualLayers.LHand;
                    break;
                case HumanoidVisualLayers.RArm:
                    yield return HumanoidVisualLayers.RArm;
                    yield return HumanoidVisualLayers.RArmExtension; // Delta V Nubody - Add Frontier RArmExtension for Harpies
