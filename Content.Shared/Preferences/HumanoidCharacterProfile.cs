...
using Content.Shared.Dataset; // Goobstation - Borg Preferred Name
using Content.Shared.GameTicking;
using Content.Shared.Humanoid;
using Content.Shared.Humanoid.Prototypes;
using Content.Shared.Preferences.Loadouts;
using Content.Shared.Random.Helpers; // GoobStation - Borg Preferred Name
...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        public HumanoidCharacterProfile(
            ...
            string flavortext,
            string species,
            string borgname, // Goobstation - Borg Preferred Name
            int age,
            Sex sex,
            Gender gender,
            ...
            Dictionary<string, RoleLoadout> loadouts)
        {
            ...
            Species = species;
            BorgName = borgname; // Goobstation - Borg Preferred Name
            Age = age;
            Sex = sex;
            Gender = gender;
