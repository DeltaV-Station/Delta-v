using Content.Shared._DV.Light.EntitySystems;
...
namespace Content.Shared._DV.Light.Components;

/// <summary>
///     Device that allows user to quickly change bulbs in <see cref="PoweredLightComponent"/>
///     Can be reloaded by new light tubes or light bulbs
/// </summary>
[RegisterComponent, NetworkedComponent, Access(typeof(DVLightReplacerSystem)), AutoGenerateComponentState]
public sealed partial class DVLightReplacerComponent : Component
{
    [DataField]
