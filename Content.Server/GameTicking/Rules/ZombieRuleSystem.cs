...
public sealed class ZombieRuleSystem : GameRuleSystem<ZombieRuleComponent>
{
    ...
    {
        // BEGIN DeltaV - End Rounds Better
        // Zombies have failed, time to go home
        ...
        if (Math.Round(infectedPercent, 0) == 0)  // All zombies defeated
        {
            _roundEnd.DoRoundEndBehavior(zombieRuleComponent.ZombieRoundEndBehavior,
                zombieRuleComponent.EvacShuttleTime,
                zombieRuleComponent.RoundEndTextSender,
                zombieRuleComponent.RoundEndTextShuttleCall,
                zombieRuleComponent.RoundEndTextAnnouncement);
