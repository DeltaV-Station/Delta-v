...
public sealed class TileWallsCommand : IConsoleCommand
{
    ...
    public static readonly ProtoId<ContentTileDefinition> TilePrototypeId2 = "FloorCave"; // DeltaV - Add cave floor under asteroid rocks
    public static readonly ProtoId<TagPrototype> WallTag = "Wall";
    public static readonly ProtoId<TagPrototype> NaturalTag = "Natural"; // DeltaV - Add cave floor under asteroid rocks
    public static readonly ProtoId<TagPrototype> WoodenTag = "Wooden"; // DeltaV - Ignore wooden support walls
    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        var naturalunderplating = _tileDefManager[TilePrototypeId2]; // DeltaV - Add cave floor under asteroid rocks
        var naturalunderplatingTile = new Tile(naturalunderplating.TileId); // DeltaV - Add cave floor under asteroid rocks
        var changed = 0;
        ...
        while (enumerator.MoveNext(out var child))
        {
            ...
            if (tagSystem.HasTag(child, DiagonalTag) || tagSystem.HasTag(child, WoodenTag)) // DeltaV - Ignore wooden support walls
            {
                continue;
            }
            ...
            // DeltaV - Begin add natural wall tile replace
            ...
            // DeltaV - end add natural wall tile replace
