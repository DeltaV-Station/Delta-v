...
public sealed partial class IonStormRuleComponent : Component
{
    ...
    /// <summary>
    /// The minimum delay before a synth affected by the ion storm gets electrocuted.
    /// </summary>
    [DataField]
    public int SynthElectrocutionDelayMin = 3;

    /// <summary>
    /// The maximum delay before a synth affected by the ion storm gets electrocuted.
    /// </summary>
    [DataField]
    public int SynthElectrocutionDelayMax = 10;

    /// <summary>
    /// The minimum damage dealt by the synth electrocution.
    /// </summary>
    [DataField]
    public int SynthElectrocutionDamageMin = 5;

    /// <summary>
    /// The maximum damage dealt by the synth electrocution.
    /// </summary>8
    [DataField]
    public int SynthElectrocutionDamageMax = 10;

    /// <summary>
    /// How long the synth is stunned for by the electrocution.
    /// </summary>
    [DataField]
