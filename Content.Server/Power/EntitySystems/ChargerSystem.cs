...
internal sealed class ChargerSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        {
            var chargerEnt = charging.charger.Owner;
    ...
    private void OnInserted(EntityUid uid, ChargerComponent component, EntInsertedIntoContainerMessage args)
    {
        ...
        var charging = EnsureComp<ChargingComponent>(args.Entity);
    ...
    private CellChargerStatus GetStatus(EntityUid uid, ChargerComponent component)
    {
        ...
        foreach (var containedEntity in container.ContainedEntities)
        {
            ...
            if (!SearchForBattery(containedEntity, out _, out var heldBattery))
                continue;
