...
public sealed partial class NoosphericAcceleratorControlMenu : FancyWindow
{
    ...
    public event Action<NoosphericAcceleratorPowerState>? OnPowerState;

    private EntityUid _entity;

    public NoosphericAcceleratorControlMenu()
    {
    ...
    {
        NoosphericAcceleratorPowerState newState;
        switch (e.Value)
        {
            case 0:
                newState = NoosphericAcceleratorPowerState.Standby;
                break;
            case 1:
                newState = NoosphericAcceleratorPowerState.Level0;
                break;
            case 2:
                newState = NoosphericAcceleratorPowerState.Level1;
                break;
            case 3:
                newState = NoosphericAcceleratorPowerState.Level2;
                break;
            case 4:
                newState = NoosphericAcceleratorPowerState.Level3;
                break;
            default:
                return;
        }
    ...
    public void DataUpdate(NoosphericAcceleratorUIState uiState)
    {
    ...
    private void UpdatePowerState(NoosphericAcceleratorPowerState state, bool enabled, bool assembled, NoosphericAcceleratorPowerState maxState)
    {
        ...
        _maxStrength = maxState == NoosphericAcceleratorPowerState.Level3 ? 4 : 3;
    ...
    private void UpdatePreview(NoosphericAcceleratorUIState updateMessage)
    {
...
public sealed class PASegmentControl : Control
{
    ...
    public void SetPowerState(NoosphericAcceleratorUIState state, bool exists)
    {
        ...
        {
            NoosphericAcceleratorPowerState.Standby => "_unlitp",
            NoosphericAcceleratorPowerState.Level0 => "_unlitp0",
            NoosphericAcceleratorPowerState.Level1 => "_unlitp1",
            NoosphericAcceleratorPowerState.Level2 => "_unlitp2",
            NoosphericAcceleratorPowerState.Level3 => "_unlitp3",
            _ => ""
        };
