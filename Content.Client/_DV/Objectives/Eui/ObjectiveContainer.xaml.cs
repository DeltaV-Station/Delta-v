...
public sealed partial class ObjectiveContainer : BoxContainer
{
    ...
    private readonly SpritePickerWindow _spritePicker;
    ...
    public ObjectiveContainer(int index, ObjectiveData objective, SpriteSystem sprite)
    {
        ...
        _spritePicker = new SpritePickerWindow();
        ...
        IconSelectButton.OnPressed += _ => _spritePicker.OpenWithSprite(_objective.Info.Icon);
    }
