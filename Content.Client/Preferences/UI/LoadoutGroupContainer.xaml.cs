...
{
    private readonly ICharacterProfile? _profile;
    private readonly LoadoutGroupPrototype _groupProto;

    public event Action<ProtoId<LoadoutPrototype>>? OnLoadoutPressed;
    public event Action<ProtoId<LoadoutPrototype>>? OnLoadoutUnpressed;

    public LoadoutGroupContainer(RoleLoadout loadout, ICharacterProfile? profile, LoadoutGroupPrototype groupProto,
    ...
    public void RefreshLoadouts(RoleLoadout loadout, ICommonSession session, IDependencyCollection collection)
    {
        ...
        foreach (var loadoutProto in _groupProto.Loadouts)
        {
            ...
            var enabled = loadout.IsValid(session, _profile, loadoutProto, collection, out var reason);
