...
public sealed partial class LoadoutWindow : FancyWindow
{
    ...
    public LoadoutWindow(RoleLoadout loadout, ICharacterProfile? profile, RoleLoadoutPrototype proto,
        ICommonSession session, IDependencyCollection collection)
    {
        ...
        foreach (var group in proto.Groups)
        {
            ...
            var container = new LoadoutGroupContainer(loadout, profile, protoManager.Index(group), session, collection);
