...
namespace Content.Client.DeltaV.UserInterface.Controls;

/// <summary>
///     A majority of this is repurposed guidebook code, it sucks that I even have to do this...
///     I would've preferred to just use a TabContainer but those had the issue of going offscreen.
///     I might as well make this generic while I'm at it.
/// </summary>
[GenerateTypedNameReferences]
public sealed partial class TabbedRules : Container
{
    [Dependency] private readonly IResourceManager _resourceManager = default!;
    [Dependency] private readonly DocumentParsingManager _parsingMan = default!;

    public Dictionary<string, TabbedEntry> _entries = new();
    ...
    {
        if (item != null && item.Metadata is TabbedEntry entry)
            ShowEntry(entry);
        else
            ClearSelectedEntry();
    }
    ...
    private void ShowEntry(TabbedEntry entry)
    {
    ...
    public void UpdateEntries(
        Dictionary<string, TabbedEntry> entries,
    ...
    private IEnumerable<TabbedEntry> GetSortedRootEntries(List<string>? rootEntries)
    {
        if (rootEntries == null)
        {
