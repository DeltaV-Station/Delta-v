    ...
    public sealed partial class HealthAnalyzerWindow : FancyWindow
    {
        ...
        public HealthAnalyzerWindow()
        {
            ...
            foreach (var item in Enum.GetValues<TriageStatus>())
            {
                ...
                btn.Text = Loc.GetString($"health-analyzer-window-triage-status-{item.ToString()}");
                btn.ToolTip = Loc.GetString($"health-analyzer-window-triage-status-{item.ToString()}.ToolTip");
